...
public class BattleTest extends TestCase {
    ...
    public void testFight() {
        ...
        army1.addUnit( new InfantryUnit("Swordman", 6));
        army2.addUnit( new InfantryUnit("Swordman", 6));
    ...
    public void testSimulate() {
        ...
        Army army2 = new Army("SecondArmy");
        for(int i =0; i<100; i++){
            army1.addUnit( new InfantryUnit("Swordman", 30));
            army1.addUnit(new CommanderUnit("Commander", 20));
        }
        for(int i =0; i<100; i++){
            army2.addUnit( new InfantryUnit("Swordman", 30));
